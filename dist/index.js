...
var _HorizontalScrollCard = __webpack_require__(22);
...
exports.default = {
  name: 'Horizontal4App',
  props: ['appItem', 'title'],
  components: { downloadButton: _DownloadButton2.default },
  data: function data() {
    return {};
  },
...
__vue_options__.__file = "/Users/brucetoo/WebstormProjects/weex-demo/src/components/DownloadButton.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-df30d27c"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
  ...
  methods: {
    onDownloadClick: function onDownloadClick(app) {
      native.onDownloadClick(app, this.state);
    },
    onAppear: function onAppear(app) {
      var self = this;
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('text', {
    ...
    return _c('div', {
      ...
      staticClass: ["size"]
    }, [_vm._v(_vm._s(Math.round(app.size / 1000 * 100) / 100 + "Mb"))]), _c('downloadButton', {
      attrs: {
        "app": app
      }
    })], 1)
