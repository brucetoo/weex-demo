...
var myMixin = {
  // 声明周期函数 create发生后调用此方法
  create: function create() {
    this.hello(); // 调用hello 函数
  },
  method: {
  ...
  mixins: [myMixin],
  method: { // 对象选项 和 同名选项优先使用组件定义的，而钩子函数例如 create等函数采用合并成数组的模式顺序执行
    hello: function hello() {
      console.log('hello from component self');
    }
  }
});
...
_vue2.default.mixin({
  create: function create() {
    // 为自定义的选项 'myOption' 注入一个处理器。 ?? 处理器是什么？
...
var update = __webpack_require__(3)("26e43eea", content, false, {});
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("6c556cf8", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
exports.default = {
  ...
  data: function data() {
    return {
      ...
      bannerList: [{ src: 'https://gd2.alicdn.com/bao/uploaded/i2/T14H1LFwBcXXXXXXXX_!!0-item_pic.jpg' }, { src: 'https://gd1.alicdn.com/bao/uploaded/i1/TB1PXJCJFXXXXciXFXXXXXXXXXX_!!0-item_pic.jpg' }, { src: 'https://gd3.alicdn.com/bao/uploaded/i3/TB1x6hYLXXXXXazXVXXXXXXXXXX_!!0-item_pic.jpg' }]
    };
  },
  ...
  methods: {
    toggleCase: function toggleCase(i) {
      ...
      if (item) {
        item.label = /[A-Z]/.test(item.label) ? item.label.toLowerCase() : item.label.toUpperCase();
      }
    }
  }
};
...
Component.options.__file = "/Users/brucetoo/WebstormProjects/weex-demo/src/Card.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-3d500a2e", Component.options)
  } else {
    hotAPI.reload("data-v-3d500a2e", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("c111de44", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../node_modules/css-loader/index.js!../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-3d500a2e\",\"scoped\":true,\"hasInlineConfig\":false}!../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Card.vue", function() {
     var newContent = require("!!../node_modules/css-loader/index.js!../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-3d500a2e\",\"scoped\":true,\"hasInlineConfig\":false}!../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Card.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
// module
exports.push([module.i, "\n.card[data-v-3d500a2e] {\n    width: 650px;\n    border-width: 4px;\n    border-style: solid;\n    border-color: #E8E8E8;\n    border-radius: 20px;\n    margin: 50px;\n}\n.title[data-v-3d500a2e] {\n    text-align: center;\n    font-size: 40px;\n    color: #888;\n    background-color: #F5F5F5;\n    padding: 12px;\n    border-bottom-width: 2px;\n    border-bottom-style: solid;\n    border-bottom-color: #E0E0E0;\n}\n.body[data-v-3d500a2e] {\n    height: 200px;\n    -ms-flex-pack: center;\n        justify-content: center;\n}\n.label[data-v-3d500a2e] {\n    text-align: center;\n    font-size: 100px;\n    color: #1FB5FC;\n}\n", ""]);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticStyle: _vm.$processStyle(undefined),
    style: (_vm.$processStyle(undefined))
  }, [_vm._v(_vm._s(_vm.index))]), _vm._v(" "), _c('div', {
    staticClass: "body",
    staticStyle: _vm.$processStyle(undefined),
    style: (_vm.$processStyle(undefined))
  }, [_c('text', {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-3d500a2e", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('list', _vm._l((_vm.listData), function(item, i) {
    return _c('cell', [(item.type === 'static') ? _c('slider', {
      staticClass: "slider",
      staticStyle: _vm.$processStyle(undefined),
      style: (_vm.$processStyle(undefined)),
      attrs: {
    ...
    })) : _vm._e(), _vm._v(" "), (item.type === 'dynamic') ? _c('div', {
      staticStyle: _vm.$processStyle(undefined),
      style: (_vm.$processStyle(undefined)),
      on: {
